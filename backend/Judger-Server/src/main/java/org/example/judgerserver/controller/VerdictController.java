...
public class VerdictController {
    ...
    public Verdict getSimilarVerdict(@PathVariable Long id) {
        throw new ResponseStatusException(HttpStatus.NOT_IMPLEMENTED, "Similarity logic not implemented yet");
    }
